...
4. 再收素材：单条给链接/文案/截图；片头/片尾动效可补图片或视频素材；解码 DNA / 生成 Style 至少给 10 条公开作品样本。
5. 如果是新账号或客户账号，先生成可应用的账号 Style，再进入单条封面生产。
...
给 Agent 一个抖音主页/作品链接，并补充至少 10 条公开作品样本，例如标题、封面文字、文案或截图转文字。系统会先提炼账号 DNA，再输出栏目、视觉风格、设计方向和可应用的账号 Style。
